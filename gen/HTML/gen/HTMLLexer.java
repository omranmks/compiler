// Generated from C:/Users/Omran/Documents/IntelliJ/Compiler/OmranProject/src/HTML/gen\HTMLLexer.g4 by ANTLR 4.10.1
package HTML.gen;
...
public class HTMLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"This", "Of", "Let", "Index", "NUMBER", "DoubleLeftCurlyBrace", "DoubleRightCurlyBrace", 
			"HTMLOpenTag", "HTMLCloseTag", "HTMLSelfCloseTag", "HTMLComment", "StartHTMLComment", 
			"EndHTMLComment", "GreaterOrEqual", "LessOrEqual", "ConditionalEqual", 
			"ConditionalNotEqual", "StrongConditionalEqual", "StrongConditionalNotEqual", 
			"AndOperator", "OrOperator", "String", "Number", "Boolean", "Any", "Void", 
			"Sign", "True", "False", "ElementName", "AttributeName", "NgFor", "NgIf", 
			"EventClick", "EventFocus", "DIGIT", "WORD", "Slash", "BackSlash", "Equal", 
			...
			"DoubleQuotation", "WhiteSpace", "NewLine", "CONTENT", "COMMENT"
		};
	}
