...
public class AngularParser extends Parser {
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Private) | (1L << Public) | (1L << Protected) | (1L << Constructor) | (1L << IDENTIFIER))) != 0)) {
				{
				setState(211);
				_errHandler.sync(this);
	...
	public final ClassAttributeContext classAttribute() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PlusEqual) | (1L << MinusEqual) | (1L << Equal))) != 0)) {
				{
				setState(225);
				assigningOperator();
				setState(226);
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Let) | (1L << Const) | (1L << Var) | (1L << Return) | (1L << Function) | (1L << This) | (1L << If) | (1L << For) | (1L << While) | (1L << Increment) | (1L << Decrement) | (1L << IDENTIFIER))) != 0)) {
				{
				{
				setState(246);
				blockContent();
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 45)) & ~0x3f) == 0 && ((1L << (_la - 45)) & ((1L << (True - 45)) | (1L << (False - 45)) | (1L << (MultiLinesString - 45)) | (1L << (DoubleQuotationString - 45)) | (1L << (SingleQuotationString - 45)) | (1L << (NUMBER - 45)) | (1L << (LeftParenthesis - 45)) | (1L << (LeftCurlyBrace - 45)) | (1L << (LeftSquareBracket - 45)))) != 0)) {
				{
				setState(349);
				parameters();
				}
	...
	public final WhileStatementContext whileStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 17)) & ~0x3f) == 0 && ((1L << (_la - 17)) & ((1L << (This - 17)) | (1L << (Increment - 17)) | (1L << (Decrement - 17)) | (1L << (True - 17)) | (1L << (False - 17)) | (1L << (MultiLinesString - 17)) | (1L << (DoubleQuotationString - 17)) | (1L << (SingleQuotationString - 17)) | (1L << (NUMBER - 17)) | (1L << (IDENTIFIER - 17)) | (1L << (LeftParenthesis - 17)) | (1L << (LeftCurlyBrace - 17)) | (1L << (LeftSquareBracket - 17)))) != 0)) {
				{
				setState(403);
				conditions();
				}
	...
	public final ConditionalOperatorContext conditionalOperator() throws RecognitionException {
		...
		try {
			...
			setState(429);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << GreaterThan) | (1L << GreaterOrEqual) | (1L << LessThan) | (1L << LessOrEqual) | (1L << ConditionalEqual) | (1L << ConditionalNotEqual) | (1L << StrongConditionalEqual) | (1L << StrongConditionalNotEqual))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Private) | (1L << Public) | (1L << Protected) | (1L << IDENTIFIER))) != 0)) {
				{
				setState(444);
				argument();
				}
	...
	public final StringContext string() throws RecognitionException {
		...
		try {
			...
			setState(522);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << MultiLinesString) | (1L << DoubleQuotationString) | (1L << SingleQuotationString))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
